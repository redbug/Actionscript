package mySocket {
    ...
    public class Telnet {
        ...
        public function Telnet(server:String, port:int, output:TextField) {
            // set class variables to the values passed to the constructor.
            serverURL = server;
            portNumber = port;
			_response_txt = output;
			
			Security.loadPolicyFile("xmlsocket://" + serverURL + ":"+ "3333");
...
//            Security.loadPolicyFile("http://" + serverURL + "/crossdomain.xml");
        ...
        private function msg(value:String):void {
            _response_txt.text += value;
            _response_txt.dispatchEvent(new Event(Event.CHANGE));
