...
//			}
			...
			var idealLocation	:b2Vec2 = new b2Vec2(_constume.x + _constume.mouseX, _yPos);
			var directionToTravel: b2Vec2 = new b2Vec2( idealLocation.x - _constume.x, idealLocation.y - _constume.y);
			
			
			directionToTravel.Multiply( 1 / PhysicVars.PIXEL_TO_METER );
			
//			directionToTravel.Multiply( 1 / _constume.stage.frameRate );
